        ...
        <div class="col-12">
            <div class="material-card card">
                <div class="card-header bg-info">
                    <h4 class="mb-0 text-white">Edit Organization</h4>
                </div>
                <form class="form_printerous" action="{{ url('/organizations/update') }}" enctype="multipart/form-data" method="POST">
                    {{csrf_field()}}
                        ...
                        <div class="card-body">
                            <div class="row pt-3">
                                <div class="col-md-4 center_content">
                                    <img src="{{$data['logo'] != null ? url('storage').'/'.$data['logo'] : asset('default/default.jpg')}}" class="center_image rounded-circle" id='img-upload'/>
                                    <br>
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="website" value="{{$data['website']}}" class="form-control" placeholder="Enter Organization Website">
                                        {{--                                        <small class="form-control-feedback"> This is inline help </small>--}}
                                    </div>
                                </div>
                            </div>
